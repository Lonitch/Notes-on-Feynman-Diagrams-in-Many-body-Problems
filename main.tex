...
\def\Sigmapart{\tikz[x=0.45pt,y=0.45pt,yscale=-1,xscale=1,baseline=-15.0ex]{
...
\input{IntroToDiagrams}
\newpage
\input{QuantumQuasiParticles}
\newpage
\input{QuantumParticleInFermiSys}   
\newpage
\input{VacuumAmplitude}
\newpage
\input{BirdEye}
\newpage
\input{SecQuantization}
\input{MoreQuasiPart}
\input{SingleParticlePropagatorRevisited}
\input{DysonEquation}
\newpage
\input{AppendA}
\input{AppendB}
